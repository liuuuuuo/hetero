...
import json
import pandas as pd
train_device = pd.read_csv('./data/train_device.csv')
train_rule = pd.read_csv('./data/train_rule.csv')
test_device = pd.read_csv('./data/test_device.csv')
test_rule = pd.read_csv('./data/test_rule.csv')
